  ...
  <v-card elevation="10" >
    <v-card-text>
      ...
      <div class="border-top mt-5 d-flex align-center">
        ...
        <div class="ml-auto">
          <h3 class="text-h4 font-weight-semibold">Comparativa rendimiento</h3>
        </div>
      </div>
      ...
      <div class="d-flex align-center justify-space-between mt-12">
        <div class="d-flex align-center px-2">
          <span>
            ...
            <span class="text-subtitle-1 textSecondary font-weight-medium mr-1">2024</span>
          </span>
        </div>
        <div class="d-flex align-center px-2">
          <span>
            ...
            <span class="text-subtitle-1 textSecondary font-weight-medium mr-1">2023</span>
          </span>
        </div>
        <div class="d-flex align-center px-2">
          <span>
