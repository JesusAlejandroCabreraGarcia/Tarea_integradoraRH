    ...
    children: [
        {
            path: '/',
            redirect: "/dashboards/rHumanos/Gestion",
        },
        {
            name: 'Reclutamiento',
        ...
        {
            name: 'Compensación',
            path: '/dashboards/rHumanos/Compensación',
            component: () => import('@/views/dashboards/rHumanos/Compensación/Compensacion.vue')
        },
        /*{
            name: 'Analytical',
        ...
        /*Empezamos agregar las rutas que vamos a necesitar*/ 
        {
            name: 'Areas',
            path: '/apps/Areas',
            component: () => import('@/views/apps/Areas/Areas.vue')
        },
        {
            name: 'Empleados',
            path: '/apps/Empleados',
            component: () => import('@/views/apps/Empleados/Empleados.vue')
        },
        {
            name: 'Horarios',
            path: '/apps/Horarios',
            component: () => import('@/views/apps/Horarios/Horarios.vue')
        },
        {
            name: 'Instructores',
        ...
        },
        {
            name: 'Puestos',
            path: '/apps/Puestos',
            component: () => import('@/views/apps/Puestos/Puestos.vue')
        },
        /*--------------------------------------------------------------------------------------------------*/
        {
            name: 'Chats',
